...
const arabicText: Readonly<Record<string, string>> = {
  ...
  "All website types": "كل أنواع المواقع",
  ...
  Content: "المحتوى",
  Create: "إنشاء",
  "Create a website or store": "أنشئ موقعًا أو متجرًا",
  "Choose what to create": "اختر ما تريد إنشاءه",
  "Ctrl S": "Ctrl S",
  ...
  "E-commerce template": "قالب متجر إلكتروني",
  English: "الإنجليزية",
  Error: "خطأ",
  Favicon: "أيقونة الموقع",
  Filter: "تصفية",
  "Filter by template category": "تصفية حسب فئة القالب",
  "Filter websites by system": "تصفية المواقع حسب النظام",
  Folders: "المجلدات",
  General: "عام",
  Languages: "اللغات",
  Light: "فاتح",
  Mail: "البريد",
  "Manage storefront versions separately": "إدارة إصدارات واجهة المتجر بشكل مستقل",
  Media: "الوسائط",
  "Media library": "مكتبة الوسائط",
  Monitoring: "المراقبة",
  "New website": "موقع جديد",
  "Next page": "الصفحة التالية",
  "No e-commerce templates are installed yet.": "لا توجد قوالب متاجر إلكترونية مثبتة بعد.",
  No: "لا",
  Overview: "نظرة عامة",
  Pages: "الصفحات",
  Plugins: "الإضافات",
  ...
  Save: "حفظ",
  Search: "بحث",
  "Search existing sites by name or domain": "ابحث في المواقع الحالية بالاسم أو النطاق",
  "Search existing websites": "البحث في المواقع الحالية",
  Settings: "الإعدادات",
  Status: "الحالة",
  Storefronts: "واجهات المتاجر",
  "Storefront design": "تصميم واجهة المتجر",
  Templates: "القوالب",
  Theme: "المظهر",
  Upload: "رفع",
  ...
  Websites: "المواقع",
  "Website, menu or portfolio": "موقع أو قائمة طعام أو ملف تعريفي",
  Website: "الموقع",
  "Website title": "عنوان الموقع",
  "Website display": "عرض الموقع",
  "Website editor sections": "أقسام محرر الموقع",
  "Website identity & ownership": "هوية الموقع والملكية",
  "Design & appearance": "التصميم والمظهر",
  "Content & navigation": "المحتوى والتنقل",
  "Page content editor": "محرر محتوى الصفحات",
  "Core website details, ownership, branding, and languages":
    "تفاصيل الموقع والملكية والهوية واللغات",
  "Theme, colors, global settings, and visual presentation":
    "المظهر والألوان والإعدادات العامة والعرض المرئي",
  "Edit pages, sections, and navigation labels in one workspace":
    "تحرير الصفحات والأقسام وتسميات التنقل في مساحة واحدة",
  "Manage the selected page and its editable sections":
    "إدارة الصفحة المحددة وأقسامها القابلة للتحرير",
  "Domains, publications, and final delivery controls":
    "النطاقات والمنشورات وعناصر التحكم في التسليم النهائي",
  Identity: "الهوية",
  "Review & publish": "المراجعة والنشر",
  "Show and hide sections": "إظهار وإخفاء الأقسام",
  ...
  "Add local development route": "إضافة مسار تطوير محلي",
  "All subdomains": "كل النطاقات الفرعية",
  "Comma-separated; used only with Selected only.":
    "افصل بينها بفواصل؛ تُستخدم فقط مع خيار نطاقات محددة.",
  "Connect custom domain": "ربط نطاق مخصص",
  "Custom domains": "النطاقات المخصصة",
  "Manage system base domains and generated website hostnames.":
    "إدارة نطاقات النظام الأساسية وعناوين المواقع التي ينشئها النظام.",
  None: "بدون",
  "Selected only": "نطاقات محددة فقط",
  "Website delivery": "توصيل الموقع",
  "booking, portal": "booking, portal",
  "emadramsis.com": "emadramsis.com",
...
const remainingArabicText: Readonly<Record<string, string>> = {
  ...
  "Filter by system": "تصفية حسب النظام",
  "All systems": "كل الأنظمة",
  "Websites, QR menus & portfolios": "المواقع وقوائم QR والملفات التعريفية",
  "Commerce system": "نظام التجارة",
  "E-commerce stores": "المتاجر الإلكترونية",
  "Websites, QR menus &amp; portfolios": "المواقع وقوائم QR والملفات التعريفية",
  "Template websites": "مواقع القوالب",
  Live: "مباشر",
  EGP: "جنيه مصري",
  USD: "دولار أمريكي",
  EUR: "يورو",
...
const commerceArabicText: Readonly<Record<string, string>> = {
  ...
  Actions: "الإجراءات",
  "Choose any color, add more, or remove colors.": "اختر أي لون، وأضف المزيد أو احذف الألوان.",
  ...
  "Short description (Arabic)": "الوصف المختصر (بالعربية)",
  "Full description (English)": "الوصف الكامل (بالإنجليزية)",
  "Full description (Arabic)": "الوصف الكامل (بالعربية)",
  "Product photo": "صورة المنتج",
  "No product photo": "بدون صورة للمنتج",
  "Image alt text": "النص البديل للصورة",
  "Describe the product photo": "صف صورة المنتج",
  ...
  "Store editor": "محرر المتجر",
  "Manage your storefront": "إدارة واجهة متجرك",
  "Website content": "محتوى الموقع",
  "Edit your website": "تعديل موقعك",
  ...
  "Creating claim link…": "جارٍ إنشاء رابط الاستلام…",
  "Claim link ready": "رابط الاستلام جاهز",
  "Create & send to owner": "إنشاء الرابط وإرساله للمالك",
  "Create link only": "إنشاء الرابط فقط",
  "Invitation email queued": "تمت جدولة رسالة الدعوة",
  "Subscription plan": "خطة الاشتراك",
  "No active plan": "لا توجد خطة نشطة",
  "Active until": "نشطة حتى",
  Plan: "الخطة",
  Trial: "تجريبية",
  Monthly: "شهرية",
  Yearly: "سنوية",
  "Expiry (UTC)": "تاريخ الانتهاء (UTC)",
  "Saving plan…": "جارٍ حفظ الخطة…",
  "Save plan": "حفظ الخطة",
  "Unable to create the claim link. Please try again.": "تعذر إنشاء رابط الاستلام. حاول مرة أخرى.",
  ...
  "Choose the colors available for this product.": "اختر الألوان المتاحة لهذا المنتج.",
  Items: "العناصر",
  ...
  "Preview storefront": "معاينة واجهة المتجر",
  "Storefront preview": "معاينة واجهة المتجر",
  "Loading storefront…": "جارٍ تحميل واجهة المتجر…",
  "Live storefront": "واجهة المتجر المباشرة",
  "No domain": "لا يوجد نطاق",
  "Refresh preview": "تحديث المعاينة",
  "Close preview": "إغلاق المعاينة",
  "Open section": "فتح القسم",
  "Collapse section": "طي القسم",
  "Open storefront in new tab": "فتح المتجر في تبويب جديد",
  ...
  "Storefront preview is unavailable": "معاينة واجهة المتجر غير متاحة",
  "Connect a domain to this store and its live storefront will appear here.":
    "اربط نطاقًا بهذا المتجر لتظهر واجهته المباشرة هنا.",
  Order: "الطلب",
  Orders: "الطلبات",
  "Owner email": "بريد المالك",
  "Owner email (optional)": "بريد المالك (اختياري)",
  ...
  "Primary brand color": "اللون الأساسي للعلامة التجارية",
  "Accent brand color": "اللون المميز للعلامة التجارية",
  "Surface color": "لون الأسطح والبطاقات",
  "Show floating WhatsApp button": "إظهار زر واتساب العائم",
  "WhatsApp button label": "نص زر واتساب",
  "Chat on WhatsApp": "تحدث معنا على واتساب",
  Stock: "المخزون",
