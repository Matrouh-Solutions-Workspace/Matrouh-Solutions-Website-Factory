...
const foodMenuStyles = String.raw`
  ...
  .foodMenuItemGrid{display:grid;width:100%;min-width:0;gap:clamp(.7rem,1vw,.95rem);margin-top:1rem}
  ...
  .foodMenuItem>img{display:block;width:100%;height:auto;aspect-ratio:4/3;object-fit:cover}
  .foodMenuItemBody{position:relative;padding:.95rem}
  .foodMenuItemHeading{display:flex;justify-content:space-between;gap:1rem;align-items:flex-start}
  .foodMenuItem h4{margin:0;color:var(--theme-colors-heading);font:700 1.02rem/1.28 var(--theme-typography-font-families-heading)}
  .foodMenuItemHeading>strong{flex:0 0 auto;color:var(--theme-colors-primary);font-size:.8rem}
  ...
  .foodMenuItemBody>p{margin:.65rem 0;color:var(--theme-colors-muted);font-size:.82rem;line-height:1.55}
  ...
  @media(min-width:36rem) and (max-width:47.99rem){.foodMenuItemGrid{grid-template-columns:repeat(2,minmax(0,1fr))}}
  @media(min-width:48rem){.foodMenuHero{grid-template-columns:minmax(0,1.02fr) minmax(0,.98fr);min-height:clamp(42rem,calc(100svh - 78px),56rem)}.foodMenuHeroImage{min-width:0;min-height:clamp(42rem,calc(100svh - 78px),56rem);order:2}.foodMenuHeroCopy{padding-block:4rem}.foodMenuItemGrid{grid-template-columns:repeat(auto-fill,minmax(min(15.25rem,100%),1fr))}.foodMenuVisitDetails{grid-template-columns:1fr 1fr 1fr}.foodMenuCategoryNav{margin-inline:0;padding-inline:0}.foodMenuItem--featured{grid-row:span 1}}
  @media(min-width:70rem){.foodMenuItemGrid{grid-template-columns:repeat(auto-fill,minmax(min(16rem,100%),1fr))}.foodMenuCatalog{padding-block-start:7rem}.foodMenuCategoryStack{gap:6rem}}
  ...
  @media(max-width:35.99rem){.foodMenuItem{display:grid;grid-template-columns:6.75rem minmax(0,1fr);align-items:stretch}.foodMenuItem>img{height:100%;min-height:100%;aspect-ratio:auto}.foodMenuItemBody{padding:.8rem}.foodMenuItemHeading{gap:.55rem}.foodMenuItem h4{font-size:.96rem}.foodMenuBadge{margin-top:.45rem}.foodMenuItemBody>p{margin:.5rem 0;font-size:.78rem}.foodMenuSizes{margin-top:.6rem;padding-top:.6rem}}
