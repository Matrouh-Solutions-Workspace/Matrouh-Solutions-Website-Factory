...
const cafeMenuStyles = String.raw`
  ...
  @media(max-width:46rem){.siteRoot:has(.cafeMenu) .siteHeader{gap:.65rem;padding-inline:.75rem}.siteRoot:has(.cafeMenu) .siteBrand{flex:1 1 auto;min-width:0;gap:.5rem;overflow:hidden}.siteRoot:has(.cafeMenu) .siteBrandMark{width:2rem;height:2rem}.siteRoot:has(.cafeMenu) .siteBrand strong{min-width:0;font-size:.82rem;line-height:1.25;white-space:normal;text-wrap:balance}.siteRoot:has(.cafeMenu) .siteNavigation{flex:0 0 auto;margin-inline-start:0}.cafeMenuHero{min-height:17rem}.cafeMenuServiceNote{display:none}.cafeMenuSectionIntro{display:block}.cafeMenuSectionIntro p{margin-top:.45rem;text-align:start}.cafeMenuCategoryNav{width:100%;margin-inline:0;padding-inline:0;scroll-padding-inline:.15rem;scroll-snap-type:inline proximity;overscroll-behavior-inline:contain}.cafeMenuCategoryNav a{scroll-snap-align:start}.cafeMenuCategory>header>div{display:block}.cafeMenuCategory header p{margin-top:.35rem;text-align:start}.cafeMenuItemGrid{grid-template-columns:1fr}.cafeMenuItem{grid-template-columns:6.75rem minmax(0,1fr);min-height:8.7rem}.cafeMenuItem>img{height:100%;min-height:8.7rem}.cafeMenuVisitPaper{grid-template-columns:1fr}.cafeMenuVisitDetails{grid-template-columns:1fr 1fr}.cafeMenuDietary{grid-column:auto}}
  @media(max-width:30rem){.siteRoot:has(.cafeMenu) .siteBrand strong{font-size:.75rem}.cafeMenuCategoryNav{position:static;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));overflow:visible}.cafeMenuCategoryNav a{display:grid;min-height:2.75rem;place-items:center;padding:.55rem .65rem;text-align:center;white-space:normal}.cafeMenuCategoryNav a:first-child{grid-column:1/-1}}
