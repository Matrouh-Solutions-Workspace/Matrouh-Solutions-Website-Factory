...
const cafeMenuStyles = String.raw`
  ...
  @media(max-width:47.99rem){.siteRoot:has(.cafeMenu) .siteHeader{min-height:64px;padding-inline:1rem}.cafeMenuCategoryNav{top:64px}.cafeMenuHeroCopy{padding-bottom:3.3rem}}
